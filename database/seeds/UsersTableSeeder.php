...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $users = [
            ...
            ['id' => 5, 'name' => 'Pieter', 'email' => 'pieter@wza.nl', 'email_verified_at' => now(), 'password' => bcrypt('123456'), 'role' => 'Bewoner', 'remember_token' => Str::random(15)],
            ['id' => 6, 'name' => 'Truus', 'email' => 'truus@wza.nl', 'email_verified_at' => now(), 'password' => bcrypt('123456'), 'role' => 'Bewoner', 'remember_token' => Str::random(15)],
            ['id' => 7, 'name' => 'Jan', 'email' => 'jan@wza.nl', 'email_verified_at' => now(), 'password' => bcrypt('123456'), 'role' => 'Bewoner', 'remember_token' => Str::random(15)]
        ];
