        ...
        <div class="MainContent">
            <div class="CustomCardContent">
                ...
                <p>{!!$data['event']->description!!}</p>
                    ...
                    @if (($data['event']->organiser_id == Auth::id() && $data['event']->cancelled == 0) && $data['event']->cancelled == 0 && date('d/M/Y H:i', strtotime($data['event']->date)) < date('Y-m-d H:i:s') || Auth::user()->role_id == 1)
