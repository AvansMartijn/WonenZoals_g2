            ...
            <ul>
                ...
                @foreach (Auth::user()->authorizations()->get() as $userauthorization)
                    ...
                    @if ($userauthorization->id == 6)
                        ...
                        <a href="/dashboard/sections" class="Menu-Item {{ (request()->is('dashboard/sections*', 'dashboard/nieuws', 'dashboard/nieuws/edit*', 'dashboard/nieuws/create*', 'dashboard/sponsors*', 'dashboard/bewoners*', 'dashboard/contact*', 'dashboard/location*')) ? 'Active' : '' }}">
                            <li>
